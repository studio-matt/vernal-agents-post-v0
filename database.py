...
class DatabaseManager1:
        ...
        try:
            ...
            for campaign, post_count, all_topics in campaigns:
                ...
                result.append({
                    ...
                    'progress': campaign.progress or 0,
                    'currentStep': campaign.current_step or "created",
                    'progressMessage': campaign.progress_message or "Campaign created successfully",
    ...
    def create_campaign(self, campaign_id: str, campaign_name: str, description: str, query: str, campaign_type: str, keywords_str: str, urls_str: str, trending_topics_str: str, topics_str: str, status: str, extraction_settings: dict, preprocessing_settings: dict, entity_settings: dict, modeling_settings: dict):
        session = next(self.get_db_session())
        try:
            # Create new campaign
            campaign = Campaign(
