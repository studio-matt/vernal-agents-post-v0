...
# Kill ALL Python and uvicorn processes before removal
echo "🔪 Killing all Python processes..."
sudo pkill -u ubuntu -f "python" || true
sudo pkill -u ubuntu -f "uvicorn" || true
sudo pkill -u ubuntu -f "gunicorn" || true
sudo fuser -k /home/ubuntu/vernal-agents-post-v0/venv/lib/python3.12/site-packages/sympy 2>/dev/null || true
sleep 2
